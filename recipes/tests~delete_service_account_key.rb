...
#       "recipe[giam::tests~delete_service_account_key]"
#
...
giam_service_account 'chef-e2e-test-account@graphite-playground.google.com.iam.gserviceaccount.com' do
  action :create
...
giam_service_account_key 'test-name' do
  action :delete
  service_account 'chef-e2e-test-account@graphite-playground.google.com.iam.gserviceaccount.com'
  project ENV['PROJECT']
  credential 'mycred'
end
