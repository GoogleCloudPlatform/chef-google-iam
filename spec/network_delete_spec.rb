...
describe Google::Iam::Network::Delete do
  let(:credential) { TestCred.new }
  let(:uri) { Google::Iam::NetworkBlocker::ALLOWED_TEST_URI }

  context 'verify proper request' do
    before(:each) { Google::Iam::NetworkBlocker.instance.allow_delete(uri) }
  ...
  context 'failed request' do
    before(:each) { Google::Iam::NetworkBlocker.instance.deny(uri) }
