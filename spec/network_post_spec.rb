...
describe Google::Iam::Network::Post do
  let(:credential) { TestCred.new }
  let(:uri_in) { Google::Iam::NetworkBlocker::ALLOWED_TEST_URI }
  ...
  context 'successful request' do
    before(:each) do
      Google::Iam::NetworkBlocker.instance.allow_post(
  ...
  context 'failed request' do
    before(:each) { Google::Iam::NetworkBlocker.instance.deny(uri_in) }
