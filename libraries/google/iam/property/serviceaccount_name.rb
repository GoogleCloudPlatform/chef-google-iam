...
module Google
  module Iam
    module Data
      ...
      # Imports name from service_account
      class ServiceAccountNameRef
        include Comparable

        def ==(other)
          return false unless other.is_a? ServiceAccountNameRef
      ...
      class ServiceAccountNameRefCatalog < ServiceAccountNameRef
        ...
        def resource
          ...
          raise ArgumentError, "giam_service_account[#{@title}] required"
        end
      end

      # A class to manage a JSON blob from GCP API
      # Will immediately return value from JSON blob without changes
      class ServiceAccountNameRefApi < ServiceAccountNameRef
    ...
    module Property
      # A class to manage fetching name from a service_account
      class ServiceAccountNameRef
        def self.coerce
          ->(parent_resource, value) { ::Google::Iam::Property::ServiceAccountNameRef.catalog_parse(value, parent_resource) }
        end
        ...
        def self.catalog_parse(value, parent_resource = nil)
          return if value.nil?
          return value if value.is_a? Data::ServiceAccountNameRef
          Data::ServiceAccountNameRefCatalog.new(value, parent_resource)
        end
        ...
        def self.api_parse(value)
          return if value.nil?
          return value if value.is_a? Data::ServiceAccountNameRef
          Data::ServiceAccountNameRefApi.new(value)
        end
      end
    end
  end
